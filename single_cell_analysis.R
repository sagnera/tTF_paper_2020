...
## this function generates the individual plots
...
###############################################################################
## analysis of temporal genes in the in-vivo fore-, mid- and hindbrain data  ##
###############################################################################
...
## Function to generate bubble plots from connected loom file
...
plot.mean.exp <- function(tissue = "Midbrain", genes = genes, celltype = "Neuron", latest.stage = 15, specific = TRUE, normalize = TRUE){
...
## generate heatmaps for spinal cord TFs in other regions of the nervous system

plot.heatmap.tTFs = function(tissue = "Midbrain", genes = genes, celltype = "Radial glia", latest.stage = 15, specific = TRUE, normalize = TRUE) {
...
##############################################################################
## Comparison of scRNAseq data with in-vitro RNAseq from Rayon et al. 2020  ##
##############################################################################
...
############################################################################
## analysis of temporal genes in the scRNAseq data from the mouse retina  ##
############################################################################
...
## saveRDS(seurat.retina, paste0(dir, "/input/10X_retina_data_Seurat.rds"))
## seurat.retina <- readRDS(paste0(dir, "/input/10X_retina_data_Seurat.rds"))
...
### plot temporal TFs in prenatal neurons
...
### plot neuronal temporal TFs on UMAPs
...
### plot heatmap ordered by neuronal cell types and age, function defined above
